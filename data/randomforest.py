...
print("🌲 Starting Hydration Model (Random Forest)...")
...
# No need to scale for Random Forest (optional):
...
csv_out = os.path.join(script_dir, "random_forest_predictions.csv")
...
if r2 > 0.7:
    ...
    print("❌ Low performance. Still needs work or more data.")
sys.stdout.flush()
...
def show_popup():
    ...
    messagebox.showinfo("Random Forest Summary", msg)
