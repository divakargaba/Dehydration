...
print("🤖 Starting 2-Class Hydration Classifier (Logistic Regression)...")
...
csv_out = os.path.join(script_dir, "logistic_regression_2class_predictions.csv")
...
if accuracy == 1.0:
    print("✅ Logistic Regression is highly effective. All predictions correct.")
elif accuracy >= 0.7:
    print("⚠️ Logistic Regression is moderately effective.")
else:
    print("❌ Logistic Regression underperformed. Try tuning or another model.")
...
def show_popup():
    ...
    messagebox.showinfo("Logistic Regression", msg)
